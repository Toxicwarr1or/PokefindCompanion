...
layout: questguide
gen: 1
quest_key: 'legendary_bird_rescue_valor'
...
source_file: 'legendary-bird-rescue-valor.json'
start:
  ...
  z: -403.5
steps:
  - text: 'Talk to Candela in the team base in Amber City!'
    location:
      kind: 'npc'
      x: -515.5
      "y": 129.5
    ...
    battles:
      - trainer: 'Team Rocket Member'
        ...
        team:
          ...
          - species: 'Muk'
            level: 100
  - text: 'Talk to Candela in Amber City to see if she can solve the puzzle!'
    location:
      kind: 'npc'
      x: -515.5
      "y": 129.5
    ...
    battles:
      - trainer: 'Jessie'
        ...
        team:
          ...
          - species: 'Gyarados'
            level: 100
  - text: 'Free the Moltres by clicking the lock!'
    location:
      kind: 'npc'
      x: 78.5
      "y": 10.0
      ...
      label: 'Moltres'
      town: 'Amber City'
  - text: 'Return to Candela with the good news!'
    location:
      kind: 'npc'
      x: -515.5
      "y": 129.5
    ...
    rewards:
      ...
      - 'Choice Band'
      - '3× Lucky Egg'
  - text: 'Head outside and find the Moltres!'
    location:
      kind: 'npc'
      x: 78.5
      "y": 10.0
