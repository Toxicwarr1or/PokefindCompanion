...
layout: questguide
gen: 1
quest_key: 'legendary_bird_rescue_mystic'
...
source_file: 'legendary-bird-rescue-mystic.json'
start:
  ...
  z: -585.5
steps:
  - text: 'Talk to Blanche in the team base in Snowtip City!'
    location:
      kind: 'npc'
      x: 100.5
      "y": 155.5
    ...
    battles:
      - trainer: 'Team Rocket Member'
        ...
        team:
          ...
          - species: 'Muk'
            level: 100
  - text: 'Talk to Blanche in Snowtip City to see if she can solve the puzzle!'
    location:
      kind: 'npc'
      x: 100.5
      "y": 155.5
    ...
    battles:
      - trainer: 'Jessie'
        ...
        team:
          ...
          - species: 'Gyarados'
            level: 100
  - text: 'Free the Articuno by clicking the lock!'
    location:
      kind: 'npc'
      x: 78.5
      "y": 10.0
      ...
      label: 'Articuno'
      town: 'Snowtip City'
  - text: 'Return to Blanche in Snowtip City with the good news!'
    location:
      kind: 'npc'
      x: 100.5
      "y": 155.5
    ...
    rewards:
      ...
      - 'Choice Scarf'
      - '3× Lucky Egg'
  - text: 'Head outside and find the Articuno'
    location:
      kind: 'npc'
      x: 78.5
      "y": 10.0
